...
RUN apt-get install -y wget curl tar clang rpm gfortran build-essential libpcre3-dev autoconf automake libtool nasm gcc-multilib g++-multilib python3.8 python3.8-dev
...
RUN ln -s /usr/bin/python3.8 /usr/bin/default_python
